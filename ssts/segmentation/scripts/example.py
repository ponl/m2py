...
def main(data_path=None, example_number=None, data_type=None, data_subtype=None):
    ...
    if example_number == "0":
        ...
        mm.show_overlaid_distribution(probs, data, data_type)
    ...
    ## NOTE Segmentation example using outliers
        ...
        mm.show_classification(labels, no_outliers_data, data_type)  # uses data without outliers

        # Plot classification distribution
        mm.show_classification_distributions(labels, no_outliers_data, data_type)

        # Plot classification distributions with masks
        mm.show_distributions_together(labels, no_outliers_data, data_type)  # all classes plotted together
        mm.show_distributions_separately(labels, no_outliers_data, data_type)  # each class plotted per plot
    ...
    ## NOTE Segmentation example with dimensionality reduction (PCA) across physical properties AND grain segmentation
        ...
        # Plot classification
        mm.show_classification(pre_labels, data, data_type)

        # Plot classification distributions
        mm.show_classification_distributions(pre_labels, data, data_type)
        ...
        mm.show_classification(post_labels, data, data_type)
        ...
        mm.show_distributions_together(post_labels, data, data_type)  # all grains plotted together
    ...
    ## NOTE Segmentation example with dimensionality reduction (PCA) across neighboring pixels and physical properties
        ...
        # Plot classification without outliers
        mm.show_classification(labels, no_outliers_data, data_type)
    ...
    ## NOTE Segmentation example with dimensionality reduction (PCA) across physical properties (skinny version of example 2)
        ...
        # Plot classification distributions with masks
        mm.show_distributions_together(labels, data, data_type)  # all classes plotted together
